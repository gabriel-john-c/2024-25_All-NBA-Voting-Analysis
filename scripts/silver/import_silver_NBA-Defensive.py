...
csv_path = os.path.join(current_dir, '..', '..', 'data', 'bronze', '2024-25-Kia-NBA-Defensive-Player-of-the-Year-Voter-Selections.csv')
...
export_csv_path = os.path.join(current_dir, '..', '..', 'data', 'silver', 'silver_NBA-Defensive-Player.csv')
