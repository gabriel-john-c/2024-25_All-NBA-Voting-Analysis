...
csv_path = os.path.join(current_dir, '..', '..', 'data', 'bronze', '2024-25-Kia-NBA-Clutch-Player-of-the-Year-Voter-Selections.csv')
...
export_csv_path = os.path.join(current_dir, '..', '..', 'data', 'silver', 'silver_NBA-Clutch-Player.csv')
