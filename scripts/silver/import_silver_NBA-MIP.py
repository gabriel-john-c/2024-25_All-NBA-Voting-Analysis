...
csv_path = os.path.join(current_dir, '..', '..', 'data', 'bronze', '2024-25-Kia-NBA-Most-Improved-Player-Voter-Selections.csv')
...
export_csv_path = os.path.join(current_dir, '..', '..', 'data', 'silver', 'silver_NBA-MIP.csv')
